...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        verticalSpacer = new QSpacerItem(20, 85, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Maximum);
        ...
        QObject::connect(dial, &QDial::valueChanged, spinBox, &QSpinBox::setValue);
